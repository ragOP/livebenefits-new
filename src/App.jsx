...
import Eng from './Eng';
import Ssnew2 from './Ssnew2';
import Raghibnajmi from './raghibnajmi';
import New from './New';
const App = () => {
  // sds
  return (
    <Router>
      <Routes>
      <Route path="/" element={<Raghibnajmi />} />
